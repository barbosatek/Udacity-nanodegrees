...
class Engine {
  ...
  render() {
    ...
    for (row = 0; row < this.gameSettings.backgroundContext.numRows; row++) {
      for (col = 0; col < this.gameSettings.backgroundContext.numCols; col++) {
        ...
        */
        this.ctx.drawImage(
          Resources.get(this.gameSettings.backgroundContext.rowImages[row]),
          col *
            (this.gameSettings.backgroundContext.spriteHeight -
              this.gameSettings.backgroundContext.spriteHeightPadding),
          row *
            (this.gameSettings.backgroundContext.spriteWidth -
  ...
  renderMessage(message) {
    ...
    this.ctx.fillText(
      message,
      xPadding + 25,
      yPadding + fontSize + modalHeight / 3,
      modalWidth
    );
  }
